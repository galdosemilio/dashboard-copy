...
describe('Patient profile -> measurement -> vitals', function() {
  it('Right panel allows measurement posting', function() {
    ...
    cy.visit(`/accounts/patients/${Cypress.env('clientId')}/measurements;s=vitals`);
    ...
    cy.get('input.mat-input-element[placeholder="Total Cholesterol"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Low-Density Lipoprotein"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="High-Density lipoprotein"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Very Low-Density Lipoprotein"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Triglycerides"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Fasting Glucose"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="HbA1c"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Insulin"]')
      .eq(0)
      .type('50');

    cy.get('input.mat-input-element[placeholder="HSCRP"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Body Temperature"]')
      .eq(0)
      .type('98');

    cy.get('input.mat-input-element[placeholder="Heart Rate"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Systolic Blood Pressure"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Diastolic Blood Pressure"]')
      .eq(0)
      .type('20');

    cy.get('input.mat-input-element[placeholder="Respiration Rate"]')
      .eq(0)
      .type('20');

    cy.get('form')
      .find('a.ccr-icon-button.mat-button')
      .click();
  ...
  it('Table shows vitals data and units', function() {
    ...
    cy.get('@measurementCells')
      .eq(2)
      .should('contain', '20 mg/dl');
