...
describe('Clinics -> Clinic -> Measurements', function () {
  it('Properly displays the Clinic Measurement Information', function () {
    ...
    cy.get('@dataTypeRows')
      ...
      .should('contain', '4')
      .should('contain', 'BMI')
      .should('contain', 'Lower Bound: 0')
      .should('contain', 'Upper Bound: 200')
    ...
    cy.get('@dataTypeRows')
      ...
      .should('contain', '%')
      .should('contain', 'Lower Bound: 1')
      .should('contain', 'Upper Bound: 100')
    ...
    cy.get('@dataTypeRows')
      ...
      .should('contain', 'g')
      .should('contain', 'Lower Bound: 1')
      .should('contain', 'Upper Bound: 750001')
    ...
    cy.get('@dataTypeRows')
      ...
      .should('contain', 'Lower Bound: 1')
      .should('contain', 'Upper Bound: 100000')
    ...
    cy.get('@dataTypeRows')
      ...
      .should('contain', 's')
      .should('contain', 'Lower Bound: 1')
      .should('contain', 'Upper Bound: 86400')
    ...
    cy.get('@dataTypeRows')
      ...
      .should('contain', 'ml')
      .should('contain', 'Lower Bound: 1')
      .should('contain', 'Upper Bound: 40000')
  })
  ...
  it('Properly displays the Clinic Measurement Information on Inheritance (blocked)', function () {
    ...
    cy.get('button')
      .contains('Add Measurement Label')
      .parent()
      .should('be.disabled')

    cy.get('button')
      .contains('Add Data Point Type')
      .parent()
      .should('be.disabled')
  ...
  it('Allows the provider to add a Measurement Label', function () {
    standardSetup()
    ...
    cy.get('button').contains('Add Measurement Label').click()
  ...
  it('Allows the provider to edit a Measurement Label', function () {
    standardSetup()
  ...
  it('Allows the provider to remove a Measurement Label', function () {
    standardSetup()
  ...
  it('Allows the provider to add a Data Type association', function () {
    ...
    cy.get('button').contains('Add Data Point Type').click()
