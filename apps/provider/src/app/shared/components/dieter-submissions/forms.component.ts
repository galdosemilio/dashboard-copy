...
import { AssignFormDialog } from '@app/shared/dialogs'
...
import { Form, FormSubmission } from '@app/shared/model'
...
export class DieterSubmissionsComponent implements OnInit {
  ...
  constructor(
    ...
    this.autoAssignForm =
      !!this.router.getCurrentNavigation()?.extras.state?.autoAssignForm
  }
