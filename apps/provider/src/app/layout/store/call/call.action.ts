...
export const CREATE_LOCAL_TRACKS_COMPLETE = 'CALL twilio/create local tracks complete';
export const CREATE_LOCAL_TRACKS_FAILED = 'CALL twilio/create local tracks failed';
...
export const ENABLE_CURRENT_USER_MICROPHONE = 'CALL enable current user microphone';
export const DISABLE_CURRENT_USER_MICROPHONE = 'CALL disable current user microphone';
...
export const FETCH_INITIATED_CALLS_COMPLETE = 'CALL fetch initiated calls complete';
