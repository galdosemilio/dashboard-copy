...
export class TwilioService {
  ...
  constructor(
    ...
    this.trackDisabled$.subscribe((participant) => {
      if (this.participantVideoTrackIds && this.participantVideoTrackIds.length) {
  ...
  generateLocalTracks(twilioConfiguration: TwilioConfiguration): Observable<any> {
    const self = this;
  ...
  attachLocalTracks() {
    const audioContainer = document.getElementById(this.localAudioMediaElementId);
    const videoContainer = document.getElementById(this.localVideoMediaElementId);
