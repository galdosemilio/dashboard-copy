...
export class FileExplorerContentSelectorComponent implements BindForm, OnDestroy, OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    if (this.opts.whitelistedContentTypes && this.opts.whitelistedContentTypes.length) {
