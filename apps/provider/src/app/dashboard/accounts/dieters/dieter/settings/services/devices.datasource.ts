...
import { AuthAvailableResponse, DeviceSyncResponse } from '@app/shared/selvera-api';
...
@Injectable()
export class DevicesDataSource extends TableDataSource<any, any, AuthAvailableRequest> {
  footnotes: Array<string>;

  constructor(protected notify: NotifierService, protected database: DevicesDatabase) {
    super();
  }
