...
export class AccountIdentifiersComponent
    ...
    if (this.form.controls.identifiers.touched) {
      const missingRequired = this.identifiers.find(
        (identifier: AccountIdentifier) =>
          identifier.required && !identifier.value
      )
  ...
  async ngOnInit() {
    ...
    this.form.valueChanges.pipe(untilDestroyed(this)).subscribe((controls) => {
      if (
        ...
        controls.name !== this.focusedIdentifier.name
      ) {
        ...
        this.focusedIdentifier.dirty =
          controls.value !== this.focusedIdentifier.value
  ...
  private generateGroupedForms() {
    this.groupedForms = []
    this.groupedIdentifiers.forEach(
      (group: GroupedIdentifiers, index: number) => {
        ...
        groupedForm.valueChanges
          ...
          .subscribe((controls) => {
            ...
            if (
              ...
              focusedIdentifier.dirty =
                controls.value !== focusedIdentifier.value
