...
import { AlertNotificationResponse, NotificationRequest } from '@app/shared/selvera-api';
      ...
      .map((value) => {
        ...
        switch (value.type.id) {
          ...
          case '1':
            ...
            alert.params['unit'] = this.i18n[unitLabel(units, 'composition', val)];
          ...
          case '2':
            since =
              value.payload && value.payload.lastMeasurement
                ...
                : undefined;
            alert.params['date'] = since !== undefined ? since.to(now) : undefined;
            alert.detail =
          ...
          case '5':
            if (value.payload.weight !== undefined) {
              ...
              alert.params['value'] = unitConversion(units, 'composition', weight.delta);
              alert.params['unit'] = this.i18n[unitLabel(units, 'composition', val)];
              alert.detail = _('ALERTS.WEIGHT_REGAINED');
