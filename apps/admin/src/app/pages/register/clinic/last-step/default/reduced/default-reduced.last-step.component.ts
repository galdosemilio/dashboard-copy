...
@Component({
  selector: 'ccr-page-register-clinic-default-reduced-last-step',
  templateUrl: './default-reduced.last-step.component.html'
})
export class DefaultReducedLastStepComponent {
