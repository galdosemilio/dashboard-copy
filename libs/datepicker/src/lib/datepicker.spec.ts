  ...
  describe('with MatNativeDateModule', () => {
    describe('standard datepicker', () => {
      ...
      it('open non-touch should open popup', () => {
        expect(
          document.querySelector('.cdk-overlay-pane.mat-datepicker-popup')
        ).toBeNull();
      ...
      it('open touch should open dialog', () => {
        ...
        expect(
          document.querySelector('.mat-datepicker-dialog mat-dialog-container')
        ).toBeNull();
      ...
      it('setting selected via enter press should update input and close calendar', fakeAsync(() => {
        ...
        let calendarBodyEl = document.querySelector(
          '.mat-calendar-body'
        ) as HTMLElement;
      ...
      it(
        ...
        fakeAsync(() => {
          const selectedChangedSpy = spyOn(
            testComponent.datepicker._selectedChanged,
            'next'
          ).and.callThrough();
    ...
    describe('datepicker with startView set to year', () => {
      ...
      it('should start at the specified view', () => {
        ...
        // for a date.
        expect(firstCalendarCell.textContent).toBe(
          'JAN',
      ...
      it('should be able to override the mat-datepicker-toggle icon', fakeAsync(() => {
        ...
        expect(
          fixture.nativeElement.querySelector(
            '.mat-datepicker-toggle .custom-icon'
          )
        ).toBeTruthy('Expected custom icon to be rendered.');

        expect(
          fixture.nativeElement.querySelector('.mat-datepicker-toggle mat-icon')
