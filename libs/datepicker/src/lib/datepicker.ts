...
export class MatDatepicker<D> implements OnInit, OnDestroy {
  ...
  /** Emits the selected month. This does not mean the date changed. */
  @Output()
  monthSelected: EventEmitter<D> = new EventEmitter<D>()

  /** Emits the selected year. This does not mean the date changed. */
  @Output()
  ...
  set _selected(value: D | null) {
    const valid = this._dateAdapter.clampDate(
      value,
      this._minDate,
      this._maxDate
    )
