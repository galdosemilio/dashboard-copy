...
import { FormQuestionTypeSingle, GetAllFormQuestionTypeResponse } from './responses';
...
export class FormQuestionType {
   ...
   */
  public getAll(request?: GetAllFormQuestionTypeRequest): Promise<GetAllFormQuestionTypeResponse> {
    return this.apiService.request({
      endpoint: `/content/form/question-type`,
      method: 'GET',
      version: '1.0',
