...
import { CreateFormAddendumRequest, GetAllFormAddendumRequest } from './requests';
...
export class FormAddendum {
   ...
   */
  public getAll(request: GetAllFormAddendumRequest): Promise<GetAllFormAddendumResponse> {
    return this.apiService.request({
      endpoint: `/content/form/addendum`,
      method: 'GET',
      version: '1.0',
