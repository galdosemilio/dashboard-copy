...
export class FoodConsumed {
   ...
   */
  public getAll(request: GetAllFoodConsumedRequest): Promise<GetAllFoodConsumedResponse> {
   ...
   */
  public add(request: AddFoodConsumedRequest): Promise<AddFoodConsumedResponse> {
    return this.apiService.request({
