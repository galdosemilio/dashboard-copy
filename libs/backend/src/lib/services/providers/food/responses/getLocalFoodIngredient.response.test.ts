...
import { GetLocalFoodIngredientResponse } from './getLocalFoodIngredient.response';

export const getLocalFoodIngredientResponse = createTest<GetLocalFoodIngredientResponse>(
