...
import { CreateFoodFavoriteRequest, GetAllFoodFavoriteRequest } from './requests';
...
export class FoodFavorite {
   ...
   */
  public getAll(request?: GetAllFoodFavoriteRequest): Promise<GetAllFoodFavoriteResponse> {
