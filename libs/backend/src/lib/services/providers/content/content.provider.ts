...
export class Content {
   ...
   */
  public getList(request: GetListContentRequest): Promise<GetListContentResponse> {
   ...
   */
  public getUploadUrl(request: GetUploadUrlContentRequest): Promise<GetUploadUrlContentResponse> {
    return this.apiService.request({
