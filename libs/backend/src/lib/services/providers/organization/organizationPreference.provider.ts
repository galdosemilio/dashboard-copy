...
export class OrganizationPreference {
  ...
  public createAdminPreference(preference: CreateAdminPreferenceRequest): Promise<boolean> {
    return this.apiService.request({
  ...
  public updateAdminPreference(preference: UpdateAdminPreferenceRequest): Promise<boolean> {
    return this.apiService.request({
      endpoint: `/organization/${preference.id}/preference/admin`,
      method: 'PATCH',
      version: '4.0',
