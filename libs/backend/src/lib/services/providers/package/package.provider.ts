...
import { CreatePackageRequest, GetAllPackageRequest, UpdatePackageRequest } from './requests';
...
export class Package {
   ...
   */
  public getAll(request?: GetAllPackageRequest): Promise<GetAllPackageResponse> {
