...
export class BindFormDirective implements OnInit, OnDestroy {
  ...
  @Input() useParentForm = true;
  @Input() overwriteControl = false;
  ...
  ngOnInit() {
    ...
    this.controlName = this.controlName ? this.controlName.toString() : '';
