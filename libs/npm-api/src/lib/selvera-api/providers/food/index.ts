...
class Food {
   ...
   */
  public fetchSummary(
    fetchSummaryRequest: FetchSummaryRequest
  ): Promise<Array<SummaryDataResponse>> {
   ...
   */
  public fetchAllFood(
    fetchAllFoodRequest: FetchAllFoodRequest
  ): Promise<FetchAllFoodResponse> {
    return this.apiService
      .request({
        endpoint: `/food`,
        method: `GET`,
  ...
  public fetchAllConsumed(
    fetchAllConsumedRequest: FetchAllConsumedRequest
  ): Promise<FetchAllConsumedResponse> {
    return this.apiService
      .request({
   ...
   */
  public fetchSingleConsumed(
    id: number
  ): Promise<FetchSingleConsumedMealResponse> {
    return this.apiService
      .request({
   ...
   */
  public addConsumed(
    addConsumedRequest: AddConsumedRequest
  ): Promise<AddConsumedMealResponse> {
  ...
  public fetchAllMeals(
    fetchAllMealRequest?: FetchAllMealRequest
  ): Promise<FetchAllMealResponse> {
    return this.apiService
      .request({
        endpoint: `/food/meal`,
        method: `GET`,
   ...
   */
  public fetchSingleMeal(
    id: number | string
  ): Promise<FetchSingleMealResponse> {
    return this.apiService
      .request({
      ...
      .then((response) => {
        ...
        if (response.ingredients) {
          response.ingredients.forEach(
            (i: UnderscoreDetailedIngredientResponse) => {
  ...
  public fetchMealPlans(
    request: FetchMealPlansRequest
  ): Promise<FetchAllMealPlansResponse> {
    return this.apiService.request({
  ...
  public fetchFavorite(
    fetchFavoriteMealsRequest: FetchFavoriteMealsRequest
  ): Promise<FetchFavoriteMealResponse> {
    return this.apiService
      .request({
  ...
  public deleteFavorite(
    deleteFavoriteMealRequest: DeleteFavoriteMealRequest
  ): Promise<void> {
    return this.apiService.request({
      endpoint: `/food/favorite`,
      method: 'DELETE',
  ...
  public fetchIngredient(
    ...
    return this.apiService
      .request({
        endpoint: `/food/ingredient/${encodeURIComponent(
          fetchSingleIngredientRequest.id
        )}`,
        method: 'GET',
        data: {
