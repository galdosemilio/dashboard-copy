...
class MeasurementSleep {
     ...
     */
    public fetchSleep(request?: FetchSleepMeasurementRequest): Promise<Array<FetchSleepMeasurementResponse>> {
        ...
        return this.apiService
            ...
            .then(res => {
                const response = res.map((i: FetchUnfilteredSleepMeasurementResponse) => {
                    return {
                        id: i.id,
                        userId: i.user_id,
     ...
     * @returns void
     */
    public addSleep(addSleepMeasurementRequest: AddSleepMeasurementRequest): Promise<void> {
     ...
     * @returns void
     */
    public addManualSleep(addManualSleepMeasurementRequest: AddManualSleepMeasurementRequest): Promise<void> {
    ...
    public getSegmentedTime(
        ...
        do {
            arr[0].push({ time: s.format('YYYY-MM-DDTHH:mm:ssZ'), quality: quality ? quality : 50 });
            s = s.add(15, 'minutes');
        } while (s < e);
        return arr;
    }
