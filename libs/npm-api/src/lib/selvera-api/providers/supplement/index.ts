...
class Supplement {
   ...
   */
  public search(
    searchSupplementsRequest: SearchSupplementsRequest
  ...
  public addConsumption(
    addConsumptionRequest: AddConsumptionRequest
  ): Promise<AddConsumptionResponse> {
    return this.apiService.request({
  ...
  public updateConsumption(
    updateConsumptionRequest: UpdateConsumptionRequest
  ): Promise<void> {
    return this.apiService.request({
   ...
   * @returns FetchSupplementAssociationResponse
   */
  public fetchAssociation(
    id: string
  ): Promise<FetchSupplementAssociationResponse> {
    return this.apiService.request({
  ...
  public updateAssociation(
    updateAssociationRequest: UpdateSupplementAssociationRequest
  ): Promise<void> {
    return this.apiService.request({
