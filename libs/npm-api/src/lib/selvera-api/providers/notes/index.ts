...
class Notes {
   ...
   * @returns Promise<AddResponse>
   */
  public addConsultationNote(
    request: AddConsultationNoteRequest
  ): Promise<AddResponse> {
    return this.apiService
      .request({
   ...
   */
  public fetchSingleConsultationNote(
    id: string
  ): Promise<FetchConsultationNoteResponse> {
    return this.apiService.request({
   ...
   * @returns Promise<boolean>
   */
  public updateConsultationNote(
    request: UpdateConsultationNoteRequest
  ): Promise<boolean> {
    return this.apiService.request({
