...
class FoodKey {
     ...
     */
    public fetchSingleOrganizationKey(id: string): Promise<FetchSingleOrganizationKeyResponse> {
        return this.apiService.request({
     ...
     * @returns Promise<AddResponse>
     */
    public addOrganizationKey(request: AddOrganizationKeyRequest): Promise<AddResponse> {
        return this.apiService
            .request({
                endpoint: '/key/organization',
                method: 'POST',
     ...
     */
    public updateOrganizationKey(request: UpdateOrganizationKeyRequest): Promise<boolean> {
        return this.apiService.request({
     ...
     */
    public fetchAllAccountKeys(request: FetchAllAccountKeyRequest): Promise<Array<AccountKeyEntryEntity>> {
        return this.apiService.request({
     ...
     */
    public fetchSingleAccountKey(id: string): Promise<FetchSingleAccountKeyResponse> {
        return this.apiService.request({
     ...
     */
    public fetchAllConsumed(request: FetchAllConsumedKeyRequest): Promise<FetchAllConsumedKeyResponse> {
        return this.apiService.request({
