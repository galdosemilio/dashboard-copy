...
class Phase {
     ...
     */
    public createPackage(createPackageRequest: CreatePackageRequest): Promise<InsertResponse> {
     ...
     */
    public updatePackage(updatePackageRequest: UpdatePackageRequest): Promise<void> {
        return this.apiService.request({
     ...
     */
    public fetchPackages(fetchPackagesRequest: FetchPackagesRequest): Promise<FetchPackagesResponse> {
        return this.apiService
            .request({
                endpoint: '/package',
                method: 'GET',
     ...
     * @returns Promise<InsertResponse>
     */
    public createEnrollment(createEnrollmentRequest: CreateEnrollmentsRequest): Promise<InsertResponse> {
        return this.apiService
            .request({
     ...
     */
    public fetchEnrollments(fetchEnrollmentsRequest: FetchEnrollmentsRequest): Promise<FetchEnrollmentsResponse> {
        const request = {
            active: true,
            paginate: true,
            ...fetchEnrollmentsRequest
                    ...
                    data: res.entries.map((item: any) => ({
                        ...
                        duration:
                            item.enroll_end !== null
                                ? moment.duration(moment(item.enroll_end).diff(item.enroll_start))
    ...
    public fetchHistory(
        ...
        params = {
            ...params,
            account,
            sortProperty: params && params.sortProperty ? params.sortProperty : 'enroll_start',
            sortDirection: params && params.sortDirection ? params.sortDirection : 'desc',
     ...
     */
    public fetch(account: string, organization: string): Promise<FetchPhaseResponse> {
        const request = {
            endpoint: '/package/enrollment',
            method: 'GET'
        };
     ...
     */
    public updateStart(enrollment: string | number, account: string | number, start: string): Promise<boolean> {
        return this.apiService.request({
            endpoint: '/package/enrollment',
            method: 'PUT',
            data: {
     ...
     */
    public enroll(account: string | number, shortcode: string): Promise<InsertResponse> {
