...
// Main Selector
export const selectStatus = createSelector(selectLayout, (state: ParentState) => state.status);
 ...
 * Inner Selectors
 */
export const selectMenu: MemoizedSelector<object, State['menu']> = createSelector(
  selectStatus,
  getMenu
);

export const selectPanel: MemoizedSelector<object, State['panel']> = createSelector(
  selectStatus,
  getPanel
);
